...
class Graph(CommandObj):
    def __init__(self, command, font, text_color, max_points=500, title_percent=1, alias=None):
    ...
    def update_data(self, value):
        ...
        self.title = self.font.render("{}: {:d}, {:d}, {:.0f}".format(
...
menu = Menu((obd.commands.SPEED,
             ...
             (obd.commands.RELATIVE_ACCEL_POS, "accel ped"),
...
if DEBUG >= 1:
    ...
    menu.buttons[2].update_data(300 * Unit.second)
